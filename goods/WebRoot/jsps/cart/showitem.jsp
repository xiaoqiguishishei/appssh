...
<html>
  ...
  <body>
	<form id="form1" action="${pageContext.request.contextPath }/servlet/OrderServlet" method="post">
		...
		<table width="95%" align="center" cellpadding="0" cellspacing="0">
			...
			<c:forEach items="${cartItems }" var="cartitem">
				<tr align="center">
					<td align="right">
						<a class="linkImage" href="<c:url value='/jsps/book/desc.jsp'/>"><img border="0" width="54" align="top" src="/goods/${cartitem.book.image_b }"/></a>
					</td>
					<td align="left">
