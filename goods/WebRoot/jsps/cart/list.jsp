	...
	<script type="text/javascript">
		$(function(){
		 ...
		 function updateQuantity(cartItemId,quantity) {
			 $.ajax({
				url:"/goods/servlet/CartServlet?method=updateQuantityByCartItemId",
		 ...
		 function batchDeleteCartItems() {
			 ...
			 window.location.href="/goods/servlet/CartServlet?method=batchDeleteCartItemsByIds&cartItemIds="+ids;
		 }
	  		...
	  		<table width="95%" align="center" cellpadding="0" cellspacing="0">
				...
				<c:forEach items="${cartItems }" var="cartItem">
					<tr align="center">
						...
						<td>
							<a href="${pageContext.request.contextPath }/servlet/CartServlet?method=batchDeleteCartItemsByIds&cartItemIds=${cartItem.cartItemId}">删除</a>
<%-- <a href="${pageContext.request.contextPath }/servlet/CartServlet?method=deleteCartItemByCartItemId&cartItemId=${cartItem.cartItemId}">删除</a> --%>
			...
			<form id="form1" action="${pageContext.request.contextPath }/servlet/CartServlet" method="post">
