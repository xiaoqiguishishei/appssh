...
<html>
  ...
  <body>
	<form id="form1" action="${pageContext.request.contextPath }/order/addOrderAction" method="post">
		...
		<table width="95%" align="center" cellpadding="0" cellspacing="0">
			...
			<c:forEach items="${cartItems }" var="cartitem">
				<tr align="center">
					<td align="right">
						<a class="linkImage" href="${pageContext.request.contextPath }/book/queryBookByBidAction?bid=${cartitem.book.bid}"><img border="0" width="54" align="top" src="${pageContext.request.contextPath }/${cartitem.book.image_b }"/></a>
					</td>
					<td align="left">
						<a href="${pageContext.request.contextPath }/book/findBooksByBnameAction?bname=${cartitem.book.bname }"><span>${cartitem.book.bname }</span></a>
					</td>
