...
<html>
  ...
  <body>
	...
	<div class="div1">
		<form action="${pageContext.request.contextPath }/user/updateLoginpassAction" method="post" target="_top">
		...
		<table>
			...
			<tr>
				<td align="right"></td>
				<td>
				  <img id="vCode" src="${pageContext.request.contextPath }/user/verifyCodeAction" border="1"/>
